...
public class HastaBilgilerimiGuncelle extends javax.swing.JFrame {//javax.swing.JFrame sınıfından HastaBilgilerimiGuncelle adında bir KALITIM sınıfı oluşturulur...
    ...
    public HastaBilgilerimiGuncelle() {
        initComponents();//arayüz birleşenleri başlatılır(ekranda gösterilir)...
        jTextField1.setText(hastaTCKN);//jTextField1 alanına hastanın TC'si aktarılır...
    }

    HastaBilgilerimiGuncelle(String hastaTCKN) {
        initComponents();//arayüz birleşenleri başlatılır(ekranda gösterilir)...
        this.hastaTCKN = hastaTCKN;//Constructor'a gelen TCKN hastaTCKN'ye aktarılır.
        jTextField1.setText(hastaTCKN);//jTextField1 alanına hastanın TC'si aktarılır...
    }
    ...
    private void initComponents() {
        ...
        setTitle("Hasta Bilgilerimi Güncelle ");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sigorta Seçiniz...", "Bağkur", "Emekli Sandığı", "SSK" }));
        ...
        jButton2.setText("Hasta Paneline Dön");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "update hastalar set hasta_ad = '"+jTextField2.getText()+"', hasta_soyad = '"+jTextField3.getText()+"', hasta_dogum = '"+date+"',hasta_dyeri = '"+jTextField4.getText()+"',"
               + "hasta_anne = '"+jTextField5.getText()+"',hasta_baba = '"+jTextField6.getText()+"', hasta_il = '"+jTextField7.getText()+"', hasta_ilce = '"+jTextField9.getText()+"',"
               + " hasta_adres ='"+jTextArea1.getText()+"', hasta_cins ='"+jComboBox1.getSelectedItem().toString()+"',hasta_sgk ='"+jComboBox2.getSelectedItem().toString()+"',"
               + "hasta_tel = '"+jTextField10.getText()+ "', hasta_mail = '"+jTextField11.getText()+"', hasta_sifre = '"+jTextField8.getText()+"' where hasta_tc = ?";  
        ...
        try{//exception yakalamak ve programın çalışmaya temini için try catch bloklarını kullandık.Uygun hatanın ekrana yazdırılabilmesi için
            ...
            pst.setString(1, hastaTCKN); //sorgunun içinde soru işareti ile belirtilen alan manüpile edilerek yerine hastaTCKN değişkeni gönderilir...
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new HastaKontrolPaneli(hastaTCKN).setVisible(true);//HastaKontrolPaneli hastaTCKN ile açılır. 
        this.setVisible(false);//HastaBilgilerimiGuncelle kapatılır...
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HastaBilgilerimiGuncelle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HastaBilgilerimiGuncelle().setVisible(true);
            }
        });
    }
