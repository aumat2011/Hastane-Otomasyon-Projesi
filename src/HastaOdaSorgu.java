...
public class HastaOdaSorgu extends javax.swing.JFrame {//javax.swing.JFrame sınıfından HastaOdaSorgu adında bir KALITIM sınıfı oluşturulur...

    public HastaOdaSorgu() {
    ...
    private void initComponents() {
        ...
        setTitle("Hasta Oda Sorgulama");

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 51, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Hasta Oda Sorgu ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HastaOdaSorgu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HastaOdaSorgu().setVisible(true);
            }
        });
    }
