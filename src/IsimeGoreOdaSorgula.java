...
public class IsimeGoreOdaSorgula extends javax.swing.JFrame {//javax.swing.JFrame sınıfından IsimeGoreOdaSorgula adında bir KALITIM sınıfı oluşturulur...
    ...
    public IsimeGoreOdaSorgula() {
        initComponents();//arayüz birleşenleri başlatılır(ekranda gösterilir)...
    }

    IsimeGoreOdaSorgula(String superVisorId) {//yönetici/tıbbi sekreter id'si ile bir nesne oluşturmak maksadıyla overloading yapılır ve ikinci constructor oluşturulur.
        initComponents();//arayüz birleşenleri başlatılır(ekranda gösterilir)...
    ...
    private void initComponents() {
        ...
        setTitle("İsime Göre Oda Sorgula");

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 51, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("İsime Göre Oda Sorgusu");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hasta T.C.", "Hasta Ad", "Hasta Soyad", "Oda No", "Yatak No"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new Supervisor(ID).setVisible(true); //Supervisor ID değeri ile açılır.
        this.setVisible(false); //IsimeGoreOdaSorgula kapatılır.
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //İSİME GÖRE HASTA SORGULAMA İŞLEMİ
        try {
            ...
            if (rs.next()){//veritabanında veri bulunduğu sürece çalışır.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IsimeGoreOdaSorgula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IsimeGoreOdaSorgula().setVisible(true);
            }
        });
    }
