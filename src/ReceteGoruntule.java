...
public class ReceteGoruntule extends javax.swing.JFrame {//javax.swing.JFrame sınıfından ReceteGoruntule adında bir KALITIM sınıfı oluşturulur...
    ...
    public ReceteGoruntule(String doktorTCKN) {//doktorun adını ekrana yazdırabilmek maksadıyla overloading yapılır ve ikinci constructor oluşturulur.
        initComponents();//arayüz birleşenleri başlatılır(ekranda gösterilir)...
        this.setVisible(true);
        this.dr_TC = doktorTCKN;//conrtuctor ile gelen doktorTCKN, dr_TC'ye aktarılır. bu değişken sınıf içindeki fonksiyon ve sorgularda kullanılacaktır.
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(20, 90, 740, 350);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //REÇETE GÖRÜNTÜLEME İŞLEMLERİ YAPILIR
        ...
        "where h.hasta_tc = ? and h.hasta_id = r.hasta_id and r.dr_id = d.dr_id" ;
         ...
         try //exception yakalamak ve programın çalışmaya temini için try catch bloklarını kullandık.Uygun hatanın ekrana yazdırılabilmesi için
         {
              ...
              pst.setString(1, jTextField1.getText());//sorgunun içinde soru işareti ile belirtilen alan manüpile edilerek yerine jTextField1 içindeki veri gönderilir...
              ...
              while (rs.next())//veritabanında veri bulunduğu sürece çalışacak döngü oluşturduk...
              {
                  ...
                  String tbData[] = {hastaad, hastasoyad, drad, drsoyad, recetetarihi, receteaciklama};//oluşturulan değişkenler tbData dizisine aktarılır.
                  ...
                  tblModel.addRow(tbData);//tabloya tbData dizisinin değerleri eklenir.                                               
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.setVisible(false);//ReceteGoruntule paneli kapatılır.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceteGoruntule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceteGoruntule().setVisible(true);
            }
        });
    }
